...
#include <MFRC522.h>
 ...
 constexpr uint8_t RST_PIN = D3; //Refer to the above pin layout    
 constexpr uint8_t SS_PIN = D4;  //Refer to the above pin layout    
...
void setup() {
  ...
  SPI.begin();       //Initialising SPI Bus
  rfid.PCD_Init();   //Initialising MFRC522
}
